...
//	}
	...
	public void calculateGlobalOutput () throws IOException
	{
		...
		if (stableStates.size() == 0)
		{
			...
			Logger.output(2, PerturbationPanel.getCombinationName(perturbation.getDrugs()) + "\tNA") ;
...
//			Logger.output(2, "Global output: " + globaloutput) ;
			...
			Logger.output(2, PerturbationPanel.getCombinationName(perturbation.getDrugs()) + "\t" + globaloutput)  ;
	...
	public void fixNode (String nodeName, boolean value)
	{
		...
		if (index >= 0)
		{
			Logger.output(2, "Fixing state of node " + nodeName + " value: " + value + " (equation index: " + index + ")") ;
			
			if (index >= 0)
			{
				booleanEquations.set(index, new BooleanEquation ("  " + nodeName + " *= " + value + " ")) ;
//				Logger.output(2, booleanEquations.get(index).getBooleanEquation()) ;
			}
		}
